 ...
 *
 * Catch-all error boundary when the root layout itself encounters an unhandled exception.
 * Renders required <html> and <body> tags with standalone dark styling.
 */
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  ...
  return (
    <html lang="en" className="dark">
      <body className="min-h-screen bg-[#060305] text-slate-100 flex items-center justify-center p-4 antialiased font-sans">
        <div
          role="alert"
          aria-live="assertive"
          className="max-w-md w-full rounded-2xl border border-rose-500/25 bg-[#0e0509]/95 p-6 sm:p-8 backdrop-blur-2xl shadow-2xl shadow-rose-950/30 text-center space-y-6"
        >
          {/* Glowing Error Badge */}
