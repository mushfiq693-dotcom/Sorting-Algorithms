...
export function BugReportModal({ isOpen, onClose, algorithmId }: BugReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
      <div
        className="relative w-full max-w-lg rounded-2xl border border-border bg-card p-6 sm:p-7 text-foreground shadow-2xl backdrop-blur-2xl space-y-4 animate-in zoom-in-95"
